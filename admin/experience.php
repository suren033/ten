...
<nav class="nav">
	...
	<form action="upload.php" method="post" enctype="multipart/form-data">
		<table class="experience_form">
			<tr>
				<th><input type="text" placeholder="art" class="conf_input"></th>
				<th><input type="text" placeholder="oxford" class="conf_input"></th>
				<th><input type="text" placeholder="num" class="conf_input"></th>
				<th><input type="text" placeholder="fact" class="conf_input"></th>
