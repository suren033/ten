	...
	<form action="upload.php" method="post" enctype="multipart/form-data">
		<table class="pricing_form">
			<tr>
				...
				<th><input type="text" placeholder="num" class="conf_input"></th>
				<th><input type="text" placeholder="development" class="conf_input"></th>
				<th><input type="text" placeholder="advetising" class="conf_input"></th>
				<th><input type="text" placeholder="game" class="conf_input"></th>
				<th><input type="text" placeholder="music" class="conf_input"></th>
				<th><input type="text" placeholder="hire" class="conf_input"></th>
