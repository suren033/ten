...
<body>
	...
	<form action="upload.php" method="post" enctype="multipart/form-data">
	    <table class="wrap_form">
			<tr>
				<th><input type="text" placeholder="title" class="conf_input"></th>
				<th><input type="text" placeholder="wrap" class="conf_input"></th>
				<th><input type="text" placeholder="design" class="conf_input"></th>
				<th><input type="text" placeholder="txt" class="conf_input"></th>
				<th><input type="text" placeholder="button"  class="conf_input"></th>
                <th><input type="text" placeholder="moretext" class="conf_input"></th>
                <th><input type="text" placeholder="deviationtext" class="conf_input"></th>
                <th><input type="text" placeholder="shane" class="conf_input"></th>
